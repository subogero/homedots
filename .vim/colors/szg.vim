...
hi comment		guifg=gray		ctermfg=darkGray	gui=bold 
...
hi StatusLineNC	gui=NONE	guifg=black guibg=white	ctermfg=darkGray  ctermbg=white
hi StatusLine	gui=bold	guifg=cyan	guibg=black	ctermfg=gray   ctermbg=black
hi VertSplit	gui=none	guifg=blue	guibg=white	ctermfg=darkGray  ctermbg=white
